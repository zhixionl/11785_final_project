"""
This is method 3 where we applied MLP For Convnext for ablation stuides
"""
...
class emb_mlp_convnext(nn.Module):
    def __init__(self, smpl_mean_params, pretrained=True):
        ...
        ### Here is another experiment for the ablation studies ###
        ...
        print('### Hello Convnext with 2 layers ###')
