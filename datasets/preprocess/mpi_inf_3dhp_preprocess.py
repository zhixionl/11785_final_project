...
def train_data(dataset_path, openpose_path, out_path, joints_idx, scaleFactor, extract_img=True, fits_3d=None):
    ...
    #                 img_view = os.path.join(img_name)
    ...
    #     np.savez(out_file, imgname=imgnames_,3
    #                        center=centers_,
    #                        scale=scales_,
    #                        part=parts_,
    #                        pose=fits_3d['pose'],
...
def mpi_inf_3dhp_extract(dataset_path, openpose_path, out_path, mode, extract_img=True, static_fits=None):
